...
import type {
  EKYCConsent,
  EKYCConsentInterface,
} from "../../contracts/EKYCConsent";
...
type EKYCConsentConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: EKYCConsentConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class EKYCConsent__factory extends ContractFactory {
  constructor(...args: EKYCConsentConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): EKYCConsent__factory {
    return super.connect(runner) as EKYCConsent__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EKYCConsentInterface {
    return new Interface(_abi) as EKYCConsentInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): EKYCConsent {
    return new Contract(address, _abi, runner) as unknown as EKYCConsent;
  }
}
