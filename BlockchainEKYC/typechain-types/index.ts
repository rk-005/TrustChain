...
export type { EKYC } from "./contracts/EKYC";
export { EKYC__factory } from "./factories/contracts/EKYC__factory";
export type { EKYCConsent } from "./contracts/EKYCConsent";
export { EKYCConsent__factory } from "./factories/contracts/EKYCConsent__factory";
export type { EKYCRegistry } from "./contracts/EKYCRegistry";
export { EKYCRegistry__factory } from "./factories/contracts/EKYCRegistry__factory";
